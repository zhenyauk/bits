...
class __TwigTemplate_c29c37f2dc33d20431a9555b1f0e12ea95cd7f1535001a1568959249909e21a9 extends \Twig\Template
{
...
<section class=\"category-about\">
   ...
   <section class=\"post\">
      ...
      <img class=\"post__img\" src=\"";
            ...
            echo "</h3>
                <div class=\"post__text\"><span>
                 ";
            // line 52
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($context["article"], "body", [], "array"), 0, [], "array"), "value", [], "array")));
            echo "</span>
                </div>
                <a class=\"post__link\" href=\"/node/";
            // line 54
...
";
    ...
    {
        return array (  189 => 58,  171 => 54,  166 => 52,  161 => 50,  156 => 48,  153 => 47,  150 => 46,  147 => 45,  145 => 44,  142 => 43,  140 => 42,  137 => 41,  120 => 40,  108 => 31,  101 => 26,  86 => 24,  82 => 23,  60 => 4,  55 => 1,);
    }
   ...
   <section class=\"post\">
      ...
      <img class=\"post__img\" src=\"{{img}}\" alt=\"\">
              <div class=\"post__content\"><span class=\"post__date\">20.02.2020</span>
                ...
                <div class=\"post__text\"><span>
                 {{article['body'][0]['value']|raw}}</span>
                </div>
                <a class=\"post__link\" href=\"/node/{{article['nid'][0]['value']}}\">Read more</a>
              </div>
            </div>
            {% endfor %}
...
", "modules/drupalup_controller-master/templates/article-list.html.twig", "/home/eugene/sites/server03.pp.ua/modules/drupalup_controller-master/templates/article-list.html.twig");
    }
}
